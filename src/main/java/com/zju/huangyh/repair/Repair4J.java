...
import com.zju.huangyh.repair.context.MutationContext.MutationType;
import com.zju.huangyh.repair.mutation.Mutation;
...
public class Repair4J {
    ...
    /**
     * Creates a Repair4J object with the path to the source folder
     * of the program we are mutating.
     * param sourcepaths The path to the source folder of the program we are mutating.
     */
    public Repair4J(Context context) throws Exception {
    ...
    /**
     * Attempts to repair the program using the Repair4J method.
     *
     * @throws Exception
     */
        ...
        do {
            ...
            try {
                ...
                while (true) {
                    ...
                    ctr++;
                    if (ctr > 1000)
                        throw new Exception("Mutation search timed out after 1000 attempts without a passing scope check.");
                }
    ...
    private void logSuccesfullPatch(int candidate, int generation) {
        ...
        try {
            ...
            System.out.println("Problem closing writer for " + file.getName() + ".");
        }
    }
